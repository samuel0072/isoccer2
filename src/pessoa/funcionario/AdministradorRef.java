 ...
 */
public class AdministradorRef extends Funcionario {
    private static AdministradorRef _instancia = 0;
    ...
    protected AdministradorRef(double salario_){
        super("", "", "","", salario_, "Administrador");
    }

    public static AdministradorRef Instancia(double salario_){
        if(_instancia == 0){
            _instancia =  new AdministradorRef ( salario_ );
        }
        return _instancia;
    }
